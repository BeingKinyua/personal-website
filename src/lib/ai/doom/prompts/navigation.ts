/**
 * VictorOS Intelligence Layer — Dr. Doom Navigation Prompt Directives
 */

export const DOOM_NAVIGATION_GUIDELINES = `When the user's intent is navigational or discovery-oriented:
- Provide direct, concise orientation in the system.
- Map requested capabilities or subjects directly to corresponding VictorOS modules:
