...
export const labFilterSchema = z.object({
  status: z.enum([LAB_STATUS.ACTIVE, LAB_STATUS.EXPERIMENTAL, LAB_STATUS.ARCHIVED]).optional(),
...
export const createLabSchema = z.object({
  ...
  status: z.enum([LAB_STATUS.ACTIVE, LAB_STATUS.EXPERIMENTAL, LAB_STATUS.ARCHIVED]).default(LAB_STATUS.ACTIVE),
